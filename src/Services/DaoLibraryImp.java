...
public class DaoLibraryImp implements DaoLibrary<Library> {
    ...
    public String updateReachedPage(Library library) {
        ...
        try{
           ...
           else if(library.getReachedPage()==crudOnlineBook.RecupererLivreEnLigneByid(library.getBook().getId()).getNb_page()){
    ...
    public void sendSms(User user,Library library) {
        try {
            final String ACCOUNT_SID = "AC8bf11b4617928354b8740083e87e374a";
            final String AUTH_TOKEN = "0609c5b01fad3bd803ac3bcf4dfe9778";
