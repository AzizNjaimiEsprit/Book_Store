            ...
            if (file.exists()) {
                if (Desktop.isDesktopSupported()) {
                    ...
                    do {
                        ...
                        if(reachedPage>=0 && reachedPage<=table_library.getItems().get(index).getBook().getNb_page()){
                    ...
                    }while(reachedPage<0 || reachedPage>table_library.getItems().get(index).getBook().getNb_page());
