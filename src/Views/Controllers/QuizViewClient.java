...
public class QuizViewClient extends MenuBarController implements Initializable {
    ...
    public void checkAnswer(MouseEvent mouseEvent) {
        try {
            ...
            FidelityCard fidelityCard = fidelityCardService.getFidelityCardById(connectedUser.getId());
            fidelityCardService.update(fidelityCard, fidelityCard.getPoints() + score * 10);
